...
import { getOpenClawDir, getOpenClawConfigPath, getOpenClawConfigDir, getOpenClawSkillsDir, getResourcesDir } from './paths';
...
/**
 * Built-in skills bundled with PingClaw that should be pre-deployed to
...
const PREINSTALLED_MARKER_NAME = '.pingclaw-preinstalled.json';
